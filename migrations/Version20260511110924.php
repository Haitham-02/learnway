...
final class Version20260511110924 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE schedule_change_requests DROP FOREIGN KEY FK_2627177141807E1D');
        $this->addSql('ALTER TABLE schedule_change_requests DROP FOREIGN KEY FK_262717719C650DE3');
        $this->addSql('ALTER TABLE schedule_change_requests DROP FOREIGN KEY FK_2627177172F206FB');
