...
<<<<<<< HEAD
        ...
        $this->addSql('ALTER TABLE chapter_contents CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE item_id item_id INT DEFAULT NULL, CHANGE title title VARCHAR(255) DEFAULT NULL, CHANGE created_by created_by INT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE chapter_contents ADD CONSTRAINT FK_52E37C72126F525E FOREIGN KEY (item_id) REFERENCES chapter_items (id)');
        $this->addSql('ALTER TABLE chapter_contents ADD CONSTRAINT FK_52E37C72DE12AB56 FOREIGN KEY (created_by) REFERENCES users (id)');
        $this->addSql('ALTER TABLE chapter_contents RENAME INDEX item_id TO UNIQ_52E37C72126F525E');
        ...
        $this->addSql('ALTER TABLE chapter_files CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE item_id item_id INT DEFAULT NULL, CHANGE file_path file_path VARCHAR(255) NOT NULL, CHANGE file_type file_type VARCHAR(255) DEFAULT NULL, CHANGE uploaded_by uploaded_by INT DEFAULT NULL, CHANGE uploaded_at uploaded_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE chapter_files ADD CONSTRAINT FK_867CD6E6126F525E FOREIGN KEY (item_id) REFERENCES chapter_items (id)');
        $this->addSql('ALTER TABLE chapter_files ADD CONSTRAINT FK_867CD6E6E3E73126 FOREIGN KEY (uploaded_by) REFERENCES users (id)');
        $this->addSql('ALTER TABLE chapter_files RENAME INDEX item_id TO UNIQ_867CD6E6126F525E');
        ...
        $this->addSql('ALTER TABLE chapter_progress DROP INDEX student_id, ADD UNIQUE INDEX UNIQ_C4189F43CB944F1A (student_id)');
        ...
        $this->addSql('ALTER TABLE chapter_progress CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE chapter_id chapter_id INT DEFAULT NULL, CHANGE student_id student_id INT DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT NULL, CHANGE last_accessed_at last_accessed_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE conversation_members CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE conversation_id conversation_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE role role VARCHAR(255) DEFAULT NULL, CHANGE joined_at joined_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE conversations CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE type type VARCHAR(255) NOT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE pair_hash pair_hash VARCHAR(255) DEFAULT NULL, CHANGE created_by created_by INT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE messages CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE conversation_id conversation_id INT DEFAULT NULL, CHANGE sender_id sender_id INT DEFAULT NULL, CHANGE content content LONGTEXT NOT NULL, CHANGE is_deleted is_deleted TINYINT DEFAULT NULL, CHANGE sent_at sent_at DATETIME DEFAULT NULL, CHANGE status status VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE student_enrollments DROP INDEX class_id, ADD UNIQUE INDEX UNIQ_1B38CC31EA000B10 (class_id)');
        $this->addSql('ALTER TABLE student_enrollments DROP INDEX idx_enrollment_active, ADD UNIQUE INDEX UNIQ_1B38CC31A76ED395 (user_id)');
        $this->addSql('ALTER TABLE student_enrollments DROP FOREIGN KEY `student_enrollments_ibfk_2`');
        $this->addSql('DROP INDEX idx_enrollments_filters ON student_enrollments');
        $this->addSql('DROP INDEX user_id ON student_enrollments');
        $this->addSql('ALTER TABLE student_enrollments CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE class_id class_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE student_enrollments ADD CONSTRAINT FK_1B38CC31A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE student_enrollments RENAME INDEX fk_1b38cc31c54f3401 TO IDX_1B38CC31C54F3401');
        ...
        $this->addSql('ALTER TABLE submission_files CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE submission_id submission_id INT DEFAULT NULL, CHANGE file_path file_path VARCHAR(255) NOT NULL, CHANGE file_type file_type VARCHAR(255) DEFAULT NULL, CHANGE uploaded_by uploaded_by INT DEFAULT NULL, CHANGE uploaded_at uploaded_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE users CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE role_id role_id INT DEFAULT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE first_name first_name VARCHAR(255) NOT NULL, CHANGE last_name last_name VARCHAR(255) NOT NULL, CHANGE gender gender VARCHAR(255) DEFAULT NULL, CHANGE phone phone VARCHAR(255) DEFAULT NULL, CHANGE employee_id employee_id VARCHAR(255) DEFAULT NULL, CHANGE student_id student_id VARCHAR(255) DEFAULT NULL, CHANGE is_active is_active TINYINT DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE users RENAME INDEX idx_users_role TO IDX_1483A5E9D60322AC');
        $this->addSql('ALTER TABLE message_reads DROP FOREIGN KEY `message_reads_ibfk_1`');
        $this->addSql('ALTER TABLE message_reads DROP FOREIGN KEY `message_reads_ibfk_2`');
        $this->addSql('DROP INDEX message_id ON message_reads');
        $this->addSql('ALTER TABLE message_reads MODIFY id BIGINT NOT NULL');
        $this->addSql('ALTER TABLE message_reads DROP id, DROP read_at, CHANGE message_id message_id INT NOT NULL, CHANGE user_id user_id INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (user_id, message_id)');
...
<<<<<<< HEAD
        ...
        $this->addSql('ALTER TABLE chapter_contents DROP FOREIGN KEY FK_52E37C72126F525E');
        $this->addSql('ALTER TABLE chapter_contents DROP FOREIGN KEY FK_52E37C72DE12AB56');
        $this->addSql('ALTER TABLE chapter_contents CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE title title VARCHAR(200) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE updated_at updated_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE item_id item_id BIGINT NOT NULL, CHANGE created_by created_by BIGINT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE chapter_contents RENAME INDEX uniq_52e37c72126f525e TO item_id');
        $this->addSql('ALTER TABLE chapter_files DROP FOREIGN KEY FK_867CD6E6126F525E');
        $this->addSql('ALTER TABLE chapter_files DROP FOREIGN KEY FK_867CD6E6E3E73126');
        $this->addSql('ALTER TABLE chapter_files CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE file_path file_path VARCHAR(500) NOT NULL, CHANGE file_type file_type VARCHAR(100) DEFAULT NULL, CHANGE uploaded_at uploaded_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE item_id item_id BIGINT NOT NULL, CHANGE uploaded_by uploaded_by BIGINT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE chapter_files RENAME INDEX uniq_867cd6e6126f525e TO item_id');
        ...
        $this->addSql('ALTER TABLE chapter_progress DROP INDEX UNIQ_C4189F43CB944F1A, ADD INDEX student_id (student_id)');
        ...
        $this->addSql('ALTER TABLE conversation_members CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE role role ENUM(\'MEMBER\', \'ADMIN\') DEFAULT \'MEMBER\', CHANGE joined_at joined_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE conversation_id conversation_id BIGINT NOT NULL, CHANGE user_id user_id BIGINT NOT NULL');
        ...
        $this->addSql('ALTER TABLE conversations CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE type type ENUM(\'DIRECT\', \'GROUP\') NOT NULL, CHANGE name name VARCHAR(200) DEFAULT NULL, CHANGE pair_hash pair_hash VARCHAR(64) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE created_by created_by BIGINT NOT NULL');
        ...
        $this->addSql('ALTER TABLE message_reads DROP FOREIGN KEY FK_37E6935AA76ED395');
        $this->addSql('ALTER TABLE message_reads DROP FOREIGN KEY FK_37E6935A537A1329');
        $this->addSql('ALTER TABLE message_reads ADD id BIGINT AUTO_INCREMENT NOT NULL, ADD read_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE user_id user_id BIGINT NOT NULL, CHANGE message_id message_id BIGINT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE message_reads ADD CONSTRAINT `message_reads_ibfk_1` FOREIGN KEY (message_id) REFERENCES messages (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE message_reads ADD CONSTRAINT `message_reads_ibfk_2` FOREIGN KEY (user_id) REFERENCES users (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('CREATE UNIQUE INDEX message_id ON message_reads (message_id, user_id)');
        $this->addSql('ALTER TABLE message_reads RENAME INDEX idx_37e6935aa76ed395 TO user_id');
        $this->addSql('ALTER TABLE messages DROP FOREIGN KEY FK_DB021E969AC0396');
        $this->addSql('ALTER TABLE messages DROP FOREIGN KEY FK_DB021E96F624B39D');
        $this->addSql('ALTER TABLE messages CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE content content TEXT NOT NULL, CHANGE is_deleted is_deleted TINYINT DEFAULT 0, CHANGE sent_at sent_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE status status ENUM(\'SENT\', \'DELIVERED\', \'SEEN\') DEFAULT \'SENT\', CHANGE conversation_id conversation_id BIGINT NOT NULL, CHANGE sender_id sender_id BIGINT NOT NULL');
        ...
        $this->addSql('ALTER TABLE student_enrollments DROP INDEX UNIQ_1B38CC31EA000B10, ADD INDEX class_id (class_id)');
        $this->addSql('ALTER TABLE student_enrollments DROP INDEX UNIQ_1B38CC31A76ED395, ADD INDEX idx_enrollment_active (user_id)');
        $this->addSql('ALTER TABLE student_enrollments DROP FOREIGN KEY FK_1B38CC31A76ED395');
        $this->addSql('ALTER TABLE student_enrollments CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE class_id class_id INT NOT NULL, CHANGE user_id user_id BIGINT NOT NULL');
        $this->addSql('ALTER TABLE student_enrollments ADD CONSTRAINT `student_enrollments_ibfk_2` FOREIGN KEY (user_id) REFERENCES users (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX idx_enrollments_filters ON student_enrollments (class_id)');
        $this->addSql('CREATE UNIQUE INDEX user_id ON student_enrollments (user_id, class_id)');
        $this->addSql('ALTER TABLE student_enrollments RENAME INDEX idx_1b38cc31c54f3401 TO FK_1B38CC31C54F3401');
        ...
        $this->addSql('ALTER TABLE submission_files CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE file_path file_path VARCHAR(500) NOT NULL, CHANGE file_type file_type VARCHAR(100) DEFAULT NULL, CHANGE uploaded_at uploaded_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE submission_id submission_id BIGINT NOT NULL, CHANGE uploaded_by uploaded_by BIGINT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE users CHANGE id id BIGINT AUTO_INCREMENT NOT NULL, CHANGE email email VARCHAR(150) NOT NULL, CHANGE first_name first_name VARCHAR(100) NOT NULL, CHANGE last_name last_name VARCHAR(100) NOT NULL, CHANGE gender gender ENUM(\'MALE\', \'FEMALE\') DEFAULT NULL, CHANGE phone phone VARCHAR(20) DEFAULT NULL, CHANGE employee_id employee_id VARCHAR(50) DEFAULT NULL, CHANGE student_id student_id VARCHAR(50) DEFAULT NULL, CHANGE is_active is_active TINYINT DEFAULT 1, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE role_id role_id INT NOT NULL');
